                            ...
                            <tbody id="productTableBody" className="bg-white divide-y text-center divide-gray-200">
                                {products.map((product, index) => (
                                    <tr key={index}>
                                        ...
                                        <td className="px-6 py-4 whitespace-nowrap">
                                            <a href={`${product.model}`} className="text-blue-600 hover:text-blue-900">
                                                {product.model}
                                            </a>
                                        </td>
                        ...
                        {products.map((product, index) => (
                            <div key={index} className="w-full sm:w-1/3 mt-8">
                                <div className="bg-white rounded-lg shadow-lg overflow-hidden max-w-sm mx-2">
                                    ...
                                    <a href={`${product.model}`} className="text-blue-600 block pb-3 hover:text-blue-500">
                                                {product.model}
                                            </a>
...
//             <Navbar_second />
//             <div className="container mx-auto">
//                 <h1 className="pb-3 mx-4 mt-5 font-open-sans text-[34px]">
